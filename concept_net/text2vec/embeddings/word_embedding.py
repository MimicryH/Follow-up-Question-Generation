...
import interviewDS.CN_GENERATOR.text2vec
from interviewDS.CN_GENERATOR.text2vec.embeddings.embedding import Embedding
from interviewDS.CN_GENERATOR.text2vec.processors.base_processor import BaseProcessor
from interviewDS.CN_GENERATOR.text2vec.utils.get_file import get_file
from interviewDS.CN_GENERATOR.text2vec.utils.logger import logger
from interviewDS.CN_GENERATOR.text2vec.utils.tokenizer import Tokenizer
...
class WordEmbedding(Embedding):
    ...
    def _build_token2idx_from_w2v(self):
        ...
        t0 = time.time()
        w2v = KeyedVectors.load_word2vec_format(self.w2v_path, **self.w2v_kwargs, binary=True, unicode_errors='ignore')
